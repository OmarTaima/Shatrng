...
const JoinUs = () => {
  ...
  useEffect(() => {
    // Fetch job positions when the page mounts (will be no-op if already loaded)
      ...
      <Helmet>
        ...
        {ogImage && (
          <>
            ...
            <meta property="og:image:alt" content={`Careers at ${SITE_NAME} - Join Our Team`} />
          </>
        )}
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={t('joinUs:title') || `Join Us - ${SITE_NAME}`} />
        <meta name="twitter:description" content={t('joinUs:subtitle') || `Explore career opportunities at ${SITE_NAME} and join our growing team.`} />
